...
import { Bot, UserCheck, PhoneCall, Check } from 'lucide-react';

export default function AiReceptionistSection({ onBookClick }) {
  ...
  return (
    <section id="assist" className="py-20 sm:py-28 bg-[#0A0F0D] border-b border-[#26312D]">
      <Container>
        {/* Header Label */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            <h2 className="font-sans text-4xl sm:text-6xl lg:text-7xl font-bold tracking-[-0.05em] text-[#F5F3EA] leading-[0.96]">
              Ask.<br />
              Book.<br />
              <span className="font-editorial italic font-normal text-[#4DB6A3]">Confirm.</span>
            </h2>

            <p className="text-[#7E8984] text-base leading-relaxed font-sans">
          ...
          <div className="lg:col-span-7">
            <div className="border border-[#26312D] bg-[#101613] p-6 space-y-6">
              
              <div className="flex items-center justify-between pb-4 border-b border-[#26312D] font-mono text-xs text-[#7E8984]">
                <span>AUTOMATED PATIENT ASSISTANT DEMO</span>
                <span className="text-[#4DB6A3]">24/7 ACTIVE</span>
              </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                {capabilities.map((cap, idx) => (
                  ...
                  >
                    <span className="block text-[10px] text-[#4DB6A3] mb-1">0{idx+1}</span>
              ...
              {/* Simulated Exchange */}
              <div className="bg-[#151C19] border border-[#26312D] p-5 space-y-4">
                
                {/* User Prompt */}
                <div className="space-y-1">
                  <span className="font-mono text-[10px] text-[#7E8984] uppercase">PATIENT QUERY:</span>
                  <div className="p-3 bg-[#0A0F0D] border border-[#26312D] font-mono text-xs text-[#F5F3EA]">
                ...
                <div className="space-y-1">
                  ...
                  <div className="p-4 bg-[#101613] border border-[#4DB6A3]/60 font-sans text-sm text-[#F5F3EA] leading-relaxed">
              ...
              <div className="flex flex-wrap items-center justify-between text-xs font-mono text-[#7E8984] pt-2">
                <span>Integrated with Krsnaa LIMS & PACS dispatch API</span>
                <span className="text-[#4DB6A3]">Sub-30s Human Handoff</span>
              </div>
